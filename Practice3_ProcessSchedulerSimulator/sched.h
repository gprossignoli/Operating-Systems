...
extern sched_class_t RR_dynQ_sched; //parte extra
extern sched_class_t sjf_sched;
extern sched_class_t fcfs_sched; //practica
extern sched_class_t prio_sched; //practica
...
static const sched_choice_t available_schedulers[NR_AVAILABLE_SCHEDULERS]= {
	...
	{RR_DYNQ_SCHED,"RR_DYNQ",&RR_dynQ_sched}
};
